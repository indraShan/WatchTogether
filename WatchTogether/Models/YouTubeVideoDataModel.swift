...
struct YouTubeVideoDataModel: Codable, CustomStringConvertible  {
    var videoId: String
    var detail: String {
        get {
            return "Compute this"
    ...
    struct Thumbnail: Codable {
        var defaultUrl: UrlType
        var mediumUrl: UrlType
        var highUrl: UrlType
    ...
    var description: String {
        get {
            return "videoId: \(videoId). median = \(snippet.thumbnails.highUrl.url)"
        }
    }
